 ...
 */
class CartCouponAdapter(val context: Context, private val list: List<ExchangeBean>?, private val itemClick: (info: ExchangeBean) -> Unit) : RecyclerView.Adapter<CartCouponAdapter.ViewHolder>() {
