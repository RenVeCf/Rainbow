 ...
 */
class TopicAllCommentAdapter(val context: Context, private val sortChange: (sortType: Int) -> Unit, private val list: List<TopicCommentBean>?, private val itemClick: (pos: Int, resId: Int, info: TopicCommentBean?) -> Unit) : RecyclerView.Adapter<TopicAllCommentAdapter.ViewHolder>() {
