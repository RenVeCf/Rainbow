package com.ipd.rainbow.widget.camera;
...
import com.ipd.rainbow.widget.camera.listener.ErrorListener;
import com.ipd.rainbow.widget.camera.util.AngleUtil;
import com.ipd.rainbow.widget.camera.util.CameraParamUtil;
import com.ipd.rainbow.widget.camera.util.CheckPermission;
import com.ipd.rainbow.widget.camera.util.DeviceUtil;
import com.ipd.rainbow.widget.camera.util.FileUtil;
import com.ipd.rainbow.widget.camera.util.ScreenUtils;
...
public class CameraInterface implements Camera.PreviewCallback {
     ...
     * open Camera
     */
    public void doOpenCamera(final CameraOpenOverCallback callback) {
...
//        }
        ...
        if (mediaRecorder != null) {
            ...
            if (isShort) {
                if (FileUtil.deleteFile(videoFileAbsPath)) {
                    callback.recordResult(isShort, null, null);
                }
                return;
            }
            doStopPreview();
            String fileName = saveVideoPath + File.separator + videoFileName;
            callback.recordResult(isShort, fileName, videoFirstFrame);
        }
    }
    ...
    public interface StopRecordCallback {
        void recordResult(boolean isShort, String url, Bitmap firstFrame);
    }
