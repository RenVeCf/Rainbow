...
class CollectClassRoomListFragment : ListFragment<List<ClassRoomBean>, ClassRoomBean>() {
    companion object {
        fun newInstance(): CollectClassRoomListFragment {
            return CollectClassRoomListFragment()
        }
    }
