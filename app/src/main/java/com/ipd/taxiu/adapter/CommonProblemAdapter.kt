 ...
 */
class CommonProblemAdapter(val context: Context,private val data:List<QuestionListBean>): RecyclerView.Adapter<CommonProblemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder?, position: Int) {
        holder?.itemView?.item_question?.text = data[position].title
        holder?.itemView?.tv_detailed_description?.text = data[position].content
