 ...
 * 审核成功
 */
public class AuditSuccessDialog extends Dialog {
    ...
    public AuditSuccessDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
        init(context);
    }

    protected AuditSuccessDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        private AuditSuccessDialog mDialog;

        public Builder(Context context) {
            mContext = context;
            mDialog = new AuditSuccessDialog(context);
