...
import com.ipd.taxiu.widget.camera.listener.ErrorListener;
import com.ipd.taxiu.widget.camera.util.AngleUtil;
import com.ipd.taxiu.widget.camera.util.CameraParamUtil;
import com.ipd.taxiu.widget.camera.util.CheckPermission;
import com.ipd.taxiu.widget.camera.util.DeviceUtil;
import com.ipd.taxiu.widget.camera.util.FileUtil;
import com.ipd.taxiu.widget.camera.util.ScreenUtils;
