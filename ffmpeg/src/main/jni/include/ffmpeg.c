...
int main(int argc, char **argv)
{
    ...
    av_log(NULL, AV_LOG_INFO, "======main start======");
    ...
    av_log(NULL, AV_LOG_INFO, "======编解码注册完毕======");

    show_banner(argc, argv, options);

    /* parse options and open all input/output files */
    ret = ffmpeg_parse_options(argc, argv);
    av_log(NULL, AV_LOG_INFO, "======parseOption:%d======",ret);
...
//     }
    ...
    av_log(NULL, AV_LOG_INFO, "======transcodeStart");
    if (transcode() < 0)
        exit_program(1);
    av_log(NULL, AV_LOG_INFO, "======transcodeEnd");
    ...
    av_log(NULL, AV_LOG_INFO, "======exit_program");
